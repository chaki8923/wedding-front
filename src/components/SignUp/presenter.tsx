...
export function Presenter(props: Props) {
  return (
    <div
      className="relative w-full h-screen flex flex-col justify-center font-serif items-center bg-center bg-no-repeat"
      style={{ backgroundImage: "url('/leaf19.png')" }}
    >
      ...
      <form
        className="flex flex-col items-center p-8 max-w-sm w-full mt-16 text-center"
      ...
      >
        <div className="w-full mb-4">
          ...
          />
          {props.errors.email && (
            <span className="text-red-500 text-xs">※メールアドレスの形式が正しくありません。※</span>
          )}
        </div>
        <div className="w-full mb-4">
          <input
